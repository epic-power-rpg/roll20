...
function updateEffectiveness() {
  getAttrs(['EP_t_max', 'SP_max', 'HP_max', 'highest_weapon_damage', 'highest_attack',
    ...
    const EP = getValidNumber(attrs['EP_t_max']);
    const SP = getValidNumber(attrs['SP_max']);
    const HP = getValidNumber(attrs['HP_max']);
